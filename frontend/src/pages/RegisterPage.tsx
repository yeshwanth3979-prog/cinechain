    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#0B0A14] overflow-hidden relative font-inter py-10 px-4">
            ...
            <div className="relative z-10 w-full max-w-[480px] bg-[#171421]/90 backdrop-blur-xl border border-white/5 rounded-[24px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-fade-in-up stagger-1 mx-auto">
                <h2 className="text-2xl font-bold text-white mb-8 text-center tracking-tight">Create Account</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-[#A7A7C7] mb-2 px-1">Confirm Password</label>
                        <div className="relative group">
                            <input
                                ...
                                onKeyDown={handleKeyDown}
                                className={`w-full h-[54px] pl-5 pr-12 bg-[#0B0A14] border ${confirmPassword && password !== confirmPassword ? 'border-red-500/50' : 'border-transparent'} rounded-[16px] text-white placeholder-[#A7A7C7]/50 focus:outline-none focus:border-[#7C5CFF]/50 focus:ring-2 focus:ring-[#7C5CFF]/20 focus:bg-[#171421] transition-all font-medium shadow-inner`}
                ...
                <div className="mt-8 text-center">
                    <p className="text-[#A7A7C7] font-medium text-sm">
                        ...
                        <Link to="/login" className="text-[#9F6EFF] hover:text-[#7C5CFF] hover:underline font-bold transition-all">
                            Log In
                        </Link>
                    </p>
                </div>
